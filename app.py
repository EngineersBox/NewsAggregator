from flask import Flask, request, Response, jsonify, url_for, render_template, send_from_directory
...
from modules.RateLimiter import RateLimiter
...
@cross_origin()
@RateLimiter(client_addr=request.remote_addr)
def search():
